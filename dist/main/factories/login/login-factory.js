...
const makeLoginController = () => {
    ...
    const jwtAdatper = new jwt_adapter_1.JwtAdapter(env_1.default.jwtSecret);
    const accountMongoRepository = new account_mongo_repository_1.AccountMongoRepository();
    const dbAuthentication = new db_authentication_1.DbAuthentication(accountMongoRepository, bcryptAdapter, jwtAdatper, accountMongoRepository);
